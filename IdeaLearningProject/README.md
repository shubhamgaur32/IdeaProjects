...
You may notice a message prompting to download shared indexes. If you have a good internet connection, you can accept the suggestion and speed up the project initialization.
